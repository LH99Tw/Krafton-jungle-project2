    ...
    const load = async () => {
      for (let attempt = 0; attempt < 3 && !cancelled; attempt++) {
        try {
          ...
          if (cancelled) return
          setUser({ ...data.user, blog: data.blog })
