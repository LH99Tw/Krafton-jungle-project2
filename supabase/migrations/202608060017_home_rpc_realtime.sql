...
-- Realtime is an invalidation signal only. This dedicated table exposes no
-- application row data, only the surface name and a monotonically increasing
-- version. It works on projects where the optional realtime.send helper has
